...
const serverRoutes = require("../JSfiles/server-routes"); //import file we are testing
const { save } = require("../JSfiles/save_json");
const request = require("supertest"); // supertest is a framework that allows to easily test web apis
const bodyParser = require("body-parser");

jest.mock("../JSfiles/save_json.js", () => ({
  save: jest.fn(),
}));

jest.mock("../JSfiles/usStates.json", () => [
  {
    state: "MI",
    capital: "Lansing",
